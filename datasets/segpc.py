...
class SegPC2021Dataset(Dataset):
    def __init__(self,
                 ...
                 msk_transform=None):
        # pre-set variables
        self.data_dir = data_dir if data_dir else '/nvme-data/Medical/Segmentation_UNet/datasets/SegPC/np'
        self.dataset_dir = dataset_dir if dataset_dir else '/nvme-data/Medical/Segmentation_UNet/datasets/SegPC/TCIA_SegPC_dataset/'
        self.mode = mode
        # input parameters
