...
target_fex = "png"
input_fex = "jpg"
data_dir = "/dccstor/urban/mustansar/codes/med/datasets/ISIC2018"
...
np.save(f"{data_dir}/np_1024_768/X_tr_224x224", X)
np.save(f"{data_dir}/np_1024_768/Y_tr_224x224", Y)
