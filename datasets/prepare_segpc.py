...
DATASET_DIR   = '/dccstor/urban/mustansar/codes/med/datasets/segpc/TCIA_SegPC_dataset/'
TRAIN_DIR     = DATASET_DIR + 'train/'
VAL_DIR       = DATASET_DIR + 'validation/'
SAVE_DATA_IN  = '/dccstor/urban/mustansar/codes/med/datasets/segpc/np_256_256'
