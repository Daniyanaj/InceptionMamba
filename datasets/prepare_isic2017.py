...
Dataset_add = "/dccstor/urban/mustansar/codes/med/codes/sasanet/SA2-Net-main/sa2net/SA2-Net-main/UNet_Awesome/isic2017/"
...
for idx in range(len(Tr_list)):
    ...
    # img = np.double(
    #    sc.imresize(img, [height, width, channels], interp="bilinear", mode="RGB")
    # )
