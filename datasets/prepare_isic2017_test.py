...
target_fex = "png"
input_fex = "jpg"
data_dir = "/dccstor/urban/mustansar/codes/med/codes/sasanet/SA2-Net-main/sa2net/SA2-Net-main/UNet_Awesome/isic2017/test"
imgs_dir = os.path.join(data_dir, "ISIC-2017_Test_v2_Data")
msks_dir = os.path.join(data_dir, "ISIC-2017_Test_v2_Part1_GroundTruth")
