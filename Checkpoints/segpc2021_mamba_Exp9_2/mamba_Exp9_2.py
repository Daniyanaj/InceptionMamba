...
# from models.mynet.pvtv2 import pvt_v2_b2
...
class MyNet(nn.Module):
    def __init__(
        ...
        path = "/dccstor/urban/mustansar/codes/med/codes/sasanet/SA2-Net-main/sa2net/SA2-Net-main/UNet_Awesome/models/pretrained_pth/pvt/pvt_v2_b2.pth"
